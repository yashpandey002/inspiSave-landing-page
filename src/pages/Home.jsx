        ...
        <>
            <section className="py-20 px-4 lg:mb-[200px] sm:pt-24 lg:pt-32">
                <div className="container mx-auto mb-4">
                    ...
                    <p className="max-w-[800px] mx-auto text-lg text-center text-gray-500">
                        InspiSave is a Chrome extension that lets you take a
                        screenshot of a webpage and save it directly to your
                        Notion database with just one click. It also
                        automatically includes the page's title and URL along
                        with the screenshot.
                    </p>
                </div>
                    ...
                    <div className="flex flex-col gap-5 lg:gap-10">
                        ...
                        <div className="flex flex-col-reverse lg:items-center gap-5 lg:flex-row lg:gap-8">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500">
                                    Authorize inspiSave to save content to your
                                    Notion DB.
                                </p>
                            </div>
                        </div>
            ...
            {isModalOpen ? (
                <AuthenticationMessage
                    type={isTokenAvailable ? 'success' : 'fail'}
